...
- [`docs/`](docs/README.md) — the records: the kernel in one page, the file map
  ...
  (FVD-0001 … FVD-0148); the design notes with production guidance; the open
...
- [`paper/`](paper/README.md) — the BDL Design and Formalization Monograph, the
  ...
  production to one commit (`paper/paper.md` is canonical; `body.typ` and the
  PDF are generated by `paper/build.sh`); `paper/archive/` keeps the 2026-09
  conference manuscript as history

Status: Phases 0–7, 8a/8b, 9a–9c, 10, 10b, 11, 12, 13, 14, 15 and 16 complete;
Phase 8c (surface elaboration of the remaining designer-facing forms, executable
semantics) and the final minimality audit not started —
