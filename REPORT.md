...
Project state: **Phase 8a complete** (behaviour systems: reusable
behavioural units, instantiation, binding, hierarchical composition,
flattening).  Remaining: Phase 8b surface elaboration of the remaining
