...
Project state: **Phase 8b complete** (behaviour grouping and component
extraction, on top of Phase 8a's behaviour systems).  Remaining: Phase 8c
surface elaboration of the remaining designer-facing forms + executable
