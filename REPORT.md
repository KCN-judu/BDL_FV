...
Project state: **Phase 9a complete** (list data and lossless buffered
cross-domain events, closing the Phase-5 pending item; on top of Phases
8a/8b's behaviour systems).  Remaining: Phase 8c surface elaboration of the
remaining designer-facing forms + executable semantics; final minimality
audit.
...
Ty              = bool | nat | arr Ty Ty | sem SemanticId | q Dim | opt Ty | list Ty
                                                                            (Phase 2: nominal concepts; Phase 3: quantities; Phase 9a: lists)
ConceptEnv Θ    maps SemanticId ↦ Option Ty                                 (Phase 3: representation binding, write-once, sem-free data)
Prim            registered operators; dimension algebra lives in Prim.ty     (Phase 3; Phase 4 adds bool/opt/comparison ops; Phase 9a adds list ops)
