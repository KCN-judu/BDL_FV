...
Project state: **Phase 5 complete** (clock domains + synchronization).
Remaining: Phase 6 actions / effects / arbitration; Phase 7 validation +
invalidation; Phase 8 surface elaboration + executable semantics; final
minimality audit.  Everything builds
...
* ~~Event multiplicity~~ — resolved in Phase 5 (window model); merge policies for *two sources* — Phase 6.
