...
| [`core_calculus/`](core_calculus/README.md) | _A Core Calculus for Signature-First Reactive Design_ — the kernel of `BDL/Core/` and its metatheory written as a programming-languages paper around one thesis, relation before realization: a typed semantic relationship as the primary design object, its refinement, semantic integrity, temporal interpretation, physical effect, reuse, and the mechanization                                  |
