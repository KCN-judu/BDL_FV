...
| [Phase 22](phase-22-the-concept-ladder-and-the-renaming.md)                                           | The concept ladder: concept = type, Sem block = instance; `ConceptId`; Phase 20 demoted to an experiment                  | core        | 2026-09-21 |
